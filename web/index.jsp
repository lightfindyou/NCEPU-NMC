...
<%
  ...
  String url="jdbc:mysql://127.0.0.1:3306/nmctracker?useUnicode=true&characterEncoding=UTF-8";
  Connection con;
  ResultSet resultset;
  Statement stmt;
...
//                    System.out.println("\""+resultSetOfMemberName.getString(1)+"\""+",");
                  }
                  out.println("\""+"TEST"+"\"");
                %>
        ];
  ...
  <div class="right">
    <div class="right_1">
      <form name="form1" method="get">
        <ul>
          <li>所在部门&nbsp;:&nbsp;
            <select name="apartment" onchange="showUser(this.value)" style="width:30%;height:30px">

              <%for(int i=0;i<apartment.size();i++)

              {%><option value="<%=apartment.get(i)%>"><%=apartment.get(i)%></option> <%} %>
